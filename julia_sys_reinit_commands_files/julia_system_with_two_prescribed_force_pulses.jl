force_dist_1 = [EmptySpatialField(),SpatialGaussian(0.1,0.1,-1.0,0.0,1)];
force_dist_2 = [EmptySpatialField(),SpatialGaussian(0.1,0.1,-1.0,0.0,1)];
...
my_params["sigma_1"] = 0.1
my_params["sigma_2"] = 0.1
my_params["t0_1"] = 0.5
my_params["t0_2"] = 1.0
