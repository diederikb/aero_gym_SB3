...
declare -a arguments_list=(
    ...
    "${case_parameters_dir}/wagner_steps_ramps.json --root_dir=${results_dir}/wagner --case_name=no_wake_info_1 --stacked_frames=1 --observe_previous_lift"
    "${case_parameters_dir}/wagner_steps_ramps.json --root_dir=${results_dir}/wagner --case_name=no_wake_info_2 --stacked_frames=2 --observe_previous_lift"
    "${case_parameters_dir}/wagner_steps_ramps.json --root_dir=${results_dir}/wagner --case_name=pressure_info_1 --stacked_frames=1 --observe_previous_lift --observe_previous_pressure"
    "${case_parameters_dir}/wagner_steps_ramps.json --root_dir=${results_dir}/wagner --case_name=pressure_info_2 --stacked_frames=2 --observe_previous_lift --observe_previous_pressure"
    "${case_parameters_dir}/wagner_steps_ramps.json --root_dir=${results_dir}/wagner --case_name=full_wake_info_1 --stacked_frames=1 --observe_previous_lift --observe_alpha_eff --observe_wake"
    "${case_parameters_dir}/wagner_steps_ramps.json --root_dir=${results_dir}/wagner --case_name=full_wake_info_2 --stacked_frames=2 --observe_previous_lift --observe_alpha_eff --observe_wake"
