...
case_file=case_parameters_files/viscous_single_point_force.json
results_dir=/Users/beckers/unsteady_aero_RL/results/viscous_single_point_force

case_1_id=5

declare -a arguments_list=(
    # Point forcing
    # "${case_file} --root_dir=${results_dir} --case_name=no_wake_info_4"
    # "${case_file} --root_dir=${results_dir} --case_name=pressure_info_3_4 --observe_previous_pressure --pressure_sensor_positions -0.3 0.0 0.3"
    # "${case_file} --root_dir=${results_dir} --case_name=pressure_info_7_4 --observe_previous_pressure --pressure_sensor_positions -0.3 -0.2 -0.1 0.0 0.1 0.2 0.3"
