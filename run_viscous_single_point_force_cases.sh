...
logdir=logs_viscous_single_point_force
mkdir -p $logdir
# number of times each case is run
num_runs=10

case_file=case_parameters_files/viscous_single_point_force_close.json
results_dir=/u/home/b/beckers/project-sofia/unsteady_aero_RL/results/viscous_single_point_force_close
...
declare -a arguments_list=(
    ...
    # "${case_file} --root_dir=${results_dir} --case_name=no_wake_info_4 --model_restart_dir=${results_dir}/TD3_no_wake_info_4/TD3_${case_3_id}"
    # "${case_file} --root_dir=${results_dir} --case_name=pressure_info_3_4 --observe_previous_pressure --pressure_sensor_positions -0.3 0.0 0.3 --model_restart_dir=${results_dir}/TD3_pressure_info_3_4/TD3_${case_3_id}"
    # "${case_file} --root_dir=${results_dir} --case_name=pressure_info_7_4 --observe_previous_pressure --pressure_sensor_positions -0.3 -0.2 -0.1 0.0 0.1 0.2 0.3 --model_restart_dir=${results_dir}/TD3_pressure_info_7_4/TD3_${case_3_id}"
)
